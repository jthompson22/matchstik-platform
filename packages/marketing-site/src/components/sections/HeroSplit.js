              ...
              <div className="split-item">
                <div className="hero-content split-item-content center-content-mobile">
                  ...
                  <p className="mt-0 mb-24 reveal-from-left" data-reveal-delay="200">
                    Matchstik allows you to easily transcribe, store, and search for audio files in just a few minutes, reducing the amount of time spent on transcription so you can focus on what matters.
                  </p>
                  <div className="reveal-from-left" data-reveal-delay="400">
                    <Button tag="a" color="primary" href="https:app.matchstik.io/register" wideMobile>
                      Get started
                    </Button>
                  </div>
                </div>
